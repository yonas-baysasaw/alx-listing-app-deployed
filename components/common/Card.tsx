...
const Card: React.FC<PropertyProps> = (PropertyProps) => {
  return (
    <div className="h-[422px] w-[378.56px] cursor-pointer hover:shadow-md hover:rounded-lg ">
      <Image
        ...
        alt="house image"
      />
      <ul className="p-2 flex gap-2 mt-2">
        {PropertyProps.category &&
          PropertyProps.category.map((title, idx) => (
            <Pill key={idx} title={title} />
          ))}
      </ul>
      <div className="flex items-center justify-between">
        <div>
          <h3 className=" font-semibold text-[22px]">{PropertyProps.name}</h3>
        ...
        <div className="flex items-center">
          ...
          <p className=" font-medium text=[17px] ml-2">
            {PropertyProps.rating}
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-between mt-4">
        <div className=" grid grid-cols-3 border w-[156px] rounded-full px-2 py-1">
          <div className="flex items-center">
            ...
            <p className="ml-1 text-[12.95px] font-medium">
              {PropertyProps.offers.bed}
            </p>
          </div>
          <div className="flex items-center">
            <svg
          ...
          <div className="flex items-center">
            ...
            <p className="ml-1 text-[12.95px] font-medium">
              {PropertyProps.offers.occupants}
            </p>
          </div>
        </div>
